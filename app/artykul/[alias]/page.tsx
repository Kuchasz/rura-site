    ...
    return (
        <>
            ...
            <Section>
                ...
                <div className="mt-8 max-w-prose text-base font-normal leading-normal text-gray-900 [&_a]:font-semibold [&_a]:text-orange-600 [&_iframe]:rounded-xl [&_img]:rounded-xl [&_li+li]:mt-2 [&_ol]:my-4 [&_ol]:pl-5 [&_p]:mb-4 [&_p]:mt-0 [&_ul]:my-4 [&_ul]:pl-5">
