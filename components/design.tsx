...
const buttonBase = "inline-flex min-h-[46px] cursor-pointer items-center justify-center gap-2 rounded-lg border px-[18px] py-3 pb-[13px] font-medium leading-none transition-all duration-[180ms] hover:-translate-y-px";
